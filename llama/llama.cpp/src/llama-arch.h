...
enum llm_tensor {
    ...
    LLM_TENSOR_FFN_PRE_NORM_2,    // gemma4
    LLM_TENSOR_FFN_POST_NORM_1,   // gemma4
    LLM_TENSOR_FFN_POST_NORM_2,   // gemma4
    LLM_TENSOR_FFN_GATE_UP_EXPS,  // gemma4
    LLM_TENSOR_ATTN_Q_NORM,
    LLM_TENSOR_ATTN_K_NORM,
    LLM_TENSOR_LAYER_OUT_NORM,
    LLM_TENSOR_LAYER_OUT_SCALE,   // gemma4
